...
export function EquipmentPage() {
  ...
  const page = "Equipamentos"
  const pageTitle = "Equipamentos"
  const pageDescription = "Gerencie os equipamentos cadastrados no laboratório."  
  ...
  return (
    <AppLayout currentPage={page}>
      ...
      <Container>
        ...
        <PageHeader title={pageTitle} description={pageDescription} onCreateEquipment={handleCreateEquipment} />
